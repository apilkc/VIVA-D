...
const columns = ['drive_url','drive_file_id','storage_type','source_url','document_source_url','publisher_type','source_platform','source_post_id','original_filename','mime_type','file_size','media_type','title','description','location_name','lat','lng','captured_at','taken_by','owner','contact','location_source','acknowledged','submitted_at','status'];
const defaults = { drive_url:'', drive_file_id:'', storage_type:'legacy_link', source_url:'', document_source_url:'', publisher_type:'', source_platform:'', source_post_id:'', original_filename:'', mime_type:'', file_size:0, description:'', location_name:'', captured_at:'', taken_by:'', owner:'', contact:'', location_source:'User-set', acknowledged:0, status:'published' };
...
const ready = pool.query(`
  CREATE TABLE IF NOT EXISTS media (
    ...
    source_platform TEXT NOT NULL DEFAULT '', source_post_id TEXT NOT NULL DEFAULT '', original_filename TEXT NOT NULL DEFAULT '', mime_type TEXT NOT NULL DEFAULT '', file_size BIGINT NOT NULL DEFAULT 0,
