...
const ready = pool.query(`
  CREATE TABLE IF NOT EXISTS media (
    ...
    source_platform TEXT NOT NULL DEFAULT '', source_post_id TEXT NOT NULL DEFAULT '', original_filename TEXT NOT NULL DEFAULT '', mime_type TEXT NOT NULL DEFAULT '', file_size BIGINT NOT NULL DEFAULT 0, thumbnail_url TEXT NOT NULL DEFAULT '',
